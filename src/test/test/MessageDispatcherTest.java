...
public class MessageDispatcherTest {
	...
	@Before
	public void setup() {
		mockedOutstandingRequests = spy(new ArrayBlockingQueue<MessageDispatcher<?>>(
				10));
		...
		dispatcher = new MessageDispatcher<Object>(mockedOutstandingRequests,
				mockedExpecters, mockedNonConsumableExpecters, mockedTimer,
				timeout, mockedKadServer);
	}

	@Test
	public void itShouldInsertItselfToOutstandingRequestsWhenSent()
			throws Exception {

		dispatcher.setConsumable(true).send(mockedNode, mockedRequest);
	...
	@Test
	public void itShouldRemoveItselfFromOutstandingRequestsAndExpectersWhenDone()
			throws Exception {
		dispatcher.setConsumable(true).send(mockedNode, mockedRequest);
	...
	@Test
	public void itShouldNotRemoveItselfFromExpectersWhenNonConsumableAndRegistered()
			throws Exception {
		dispatcher.setConsumable(false).register();
	...
	@Test
	public void itShouldRemoveIteselfFromExpectersWhenConsumableAndRegistered()
			throws Exception {
		dispatcher.setConsumable(true).register();
	...
	@Test
	public void itShouldWaitUntilHandleWasInvokedWhenSendAndWait()
			throws Throwable {
		...
		KadMessage recvedMessage = dispatcher.setConsumable(true)
	...
	public void itShouldTimedoutWhenSendAndWait() throws Throwable {
		...
		dispatcher.setConsumable(true).futureSend(mockedNode, mockedRequest)
				.get();

	}

	@Test
	public void itShouldWaitUntilMessageIsRecvedWhenExpecting()
			throws Throwable {
		Future<KadMessage> f = dispatcher.setConsumable(true).futureRegister();
